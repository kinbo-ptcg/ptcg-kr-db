...
pokemon_names_en.py
===================
Maps National Pokédex number → English Pokémon name.
Covers all 1025 species through Generation 9 (Pecharunt).

Also maps Korean card-name prefixes/modifiers to English so that
full card names can be reconstructed in English.
"""

# Pokédex number → English name
POKEDEX_EN: dict[int, str] = {
    # ── Generation 1 ────────────────────────────────────────────────────────
    ...
    785: "Tapu Koko", 786: "Tapu Lele",
    787: "Tapu Bulu", 788: "Tapu Fini",
    789: "Cosmog", 790: "Cosmoem",
    791: "Solgaleo", 792: "Lunala",
    793: "Nihilego", 794: "Buzzwole", 795: "Pheromosa",
    796: "Xurkitree", 797: "Kartana", 798: "Celesteela",
    799: "Guzzlord",
    800: "Necrozma",
    801: "Magearna",
    802: "Marshadow",
    ...
    880: "Dracozolt", 881: "Arctozolt",
    882: "Dracovish", 883: "Arctovish",
    884: "Duraludon",
    ...
    1001: "Wo-Chien", 1002: "Chien-Pao",
    1003: "Ting-Lu", 1004: "Chi-Yu",
    1005: "Roaring Moon",
    1006: "Iron Valiant",
...
# ── Korean card-name modifier → English translation ──────────────────────────
# Used to reconstruct the English card name from Korean tokens.

# Regional form prefixes (appear before the Pokémon name)
REGION_PREFIX_EN: dict[str, str] = {
    "가라르": "Galarian",
    "팔데아": "Paldean",
    "알로라": "Alolan",
    "히스이": "Hisuian",
...
# Non-species prefixes (branding, ownership, battle style, etc.)
NAME_PREFIX_EN: dict[str, str] = {
    "M": "Mega",           # "M 리자몽" → "Mega Charizard"
    "오리진": "Origin",
    "원시": "Primal",
    "아머드": "Armored",
    "빛나는": "Shining",
    ...
    "블랙": "Black",
    "화이트": "White",
    "백마": "White",       # White Kyurem (백마 큐레무)
    "흑마": "Black",       # Black Kyurem
    "지우": "Ash's",
    "로켓단의": "Team Rocket's",
    "마그마단의": "Team Magma's",
    "아쿠아단의": "Team Aqua's",
...
# Card-mechanic suffixes (appended after the Pokémon name)
NAME_SUFFIX_EN: dict[str, str] = {
    "EX": "EX",
    "ex": "ex",
    "GX": "GX",
    "V": "V",
